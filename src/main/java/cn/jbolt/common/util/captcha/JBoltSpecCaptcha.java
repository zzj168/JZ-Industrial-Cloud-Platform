 ...
 */
public class JBoltSpecCaptcha extends JBoltCaptcha
{
    public JBoltSpecCaptcha()
    {
    }
    public JBoltSpecCaptcha(int width, int height)
    {
        this.width = width;
        this.height = height;
    }
    public JBoltSpecCaptcha(int width, int height, int len){
        this(width,height);
        this.len = len;
    }
    public JBoltSpecCaptcha(int width, int height, int len, Font font){
