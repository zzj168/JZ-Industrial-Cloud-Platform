...
public class CurdWithPageDemoController extends BaseController {
	@Inject
	private JBoltVersionService service;
	public void index() {
		set("pageData", service.paginateByKeywords("id", "desc", getPageNumber(), getPageSize(), getKeywords(), "version"));
		keepPara();
		render("index.html");
	}
	public void add() {
